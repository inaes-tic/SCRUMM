...
**** DONE Improve communication with Caspa
     ...
     :END:
**** TODO Include JMR new media sources
** [0/4] Josx
*** [0/3] MBC-Etiquette upgrades
**** TODO Unify models (server and editor)
**** TODO Serve filter from server as a view
**** TODO Move scheduling to the filter code
** [0/1] Leo
*** TODO Refactor video editor with backbone and knockout
** [0/1] Mariana
