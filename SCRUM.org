...
* <2014-02-24 Mon> [1/14]
** [0/2] Adri
*** TODO IfNotEtcd: NDN / Redis for distributed config
*** [0/1] iobackends to Mosto
**** TODO reimplement Mosto messages to Caspa
** [0/1] Josx
*** [0/1] SearchBox adjustments
**** TODO Check typeahead
** [1/11] Mariana
*** [1/11] Trámites administrativos
**** DONE Cambiar clave fiscal AFIP
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2014-02-17 Mon 16:43]
     :END:
**** TODO Facturar Febrero a Cooperar
**** TODO Cambiar domicilio fiscal
**** TODO Solicitar talonario de facturas nuevas
**** TODO Facturar Marzo a Cooperar
**** TODO Armar bibliorato de gastos y egresos
**** TODO Fotocopia de monotributos al día
...
**** DONE Detecting products with avahi
     ...
     :END:
**** STARTED Wrapped webkit config editor for patero
