...
** alejo
*** TODO Mapa de Malbec (terminar)
** adri
*** TODO Caspa: navigator-like view switching
** jmr
...
** niv
*** TODO Auth
*** TODO Backbone.io sync en server
...
*** DONE WebFxUI: center editor screen
    ...
    :END:
*** STARTED WebFxUI: ask before leaving view and losing content
    :LOGBOOK:
    - State "STARTED"    from "TODO"       [2013-12-02 Mon 10:52]
    :END:
*** STARTED WebFxUI: do not lose content when changing resolution
    :LOGBOOK:
    - State "STARTED"    from "TODO"       [2013-12-02 Mon 10:52]
    :END:
...
*** DONE Armar manual para los diseñadores para CN23
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2013-12-09 Mon 16:31]
    :END:
*** DONE Clasificar diseñadores
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2013-12-09 Mon 16:31]
