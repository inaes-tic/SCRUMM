...
<2013-04-08 Mon> blockeado por driver redis

*** STARTED driver redis
...
*** STARTED driver mubsub: pull playlist
Empecé con los arreglos que hablamos en la mailing list al driver de
playlists de mongodb: permitirle a mosto pollear las playlists que
necesita
*** STARTED tests mocha
:LOGBOOK:
...
*** STARTED mbc-common
init db
driver de mosto recive json de conf
migrar codigo de caspa

*

* <2013-04-08 Mon> Objetivos
** [0/2] diego
*** STARTED snapp de los eventos: notificacion superpuestos
:LOGBOOK:
- State "STARTED"    from "TODO"       [2013-04-05 Fri 14:19]
:END:

*** TODO merge pull requests
** [0/3] adrian
*** STARTED fila vacia
...
*** TODO Conf module en backbone.io
*** TODO UI de configuración
** [0/3] tom
** [0/1] juan martin
*** TODO test test test
** [0/4] fabricio
