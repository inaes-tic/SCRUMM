...
Trabado porque alejo está leyendo el estatuto
*** TODO Chequera
Mala no pudo juntarse en la semana
*** DONE Permiso de facturación AFIP
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2013-10-25 Fri 12:02]
    :END:
*** TODO Convenio COOPERAR
...
Falta el video, corregir los mensajes, ver si hacemos el sitio de demo.
...
*** DONE Resumen pago diseñadores
    ...
    :END:
*** TODO Ajustes de diseño a WebFX
*** TODO Tests de Caspa
**** TODO Hablar con Josx para entender la estructura
**** TODO Tests para las funcionalidades de los modelos
** tom
