...
* <2014-01-20 Mon> [1/5]
** [0/1] Adri
*** STARTED Generic Redis+Mongo transport layer
    :LOGBOOK:
    - State "STARTED"    from "TODO"       [2014-01-15 Wed 10:22]
    :END:
**** Needs to fix server side
** [0/1] Josx
...
**** DONE Pagar Diciembre
     ...
     :END:
**** TODO Recalcular enero (paternidad JMR)
