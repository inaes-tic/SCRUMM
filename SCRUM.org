...
tech talks > 
1) fabricio : vídeo y streaming > miércoles 15 de mayo
2) adrián : backbone + backbone relational > miércoles 22 de mayo
3) tom : nueva arquitectura de mosto 


VIERNES
- terminar los tests de mosto
- prototipos de fetch y de sync con proof of concept con backbone > niv sube su ejemplo
- tom > metatest mosto
