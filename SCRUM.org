...
* <2014-03-25 Tue> [2/14]
** [1/4] Leo
*** TODO mbc-caspa integration testing support...
*** STARTED Review Bower PR
    :LOGBOOK:
...
** [0/4] Mariana
*** TODO Coordinar reunión Contador para asamblea
*** TODO Confirmar firmas en recibos y libro de asociados
*** TODO Pago honorarios contadores
*** TODO Finalización informe febrero
** [0/2] Pato
*** TODO gnucash, informes para contador (IVA, IIBB)
*** STARTED Review Bower PR
    :LOGBOOK:
    - State "STARTED"    from "TODO"       [2014-03-26 mié 08:21]
    :END:
** [1/4] Josx
*** TODO Add more libs to bower
*** TODO d3timeline review current code
*** TODO server routes to common
...
*** STARTED Move config to own serve
    ...
    :END:
*** STARTED Move config view to common
    :LOGBOOK:
    - State "STARTED"    from "TODO"       [2014-03-25 mar 08:24]
    :END:
