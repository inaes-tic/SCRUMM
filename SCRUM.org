...
*** REVIEWING create with id
    :LOGBOOK:
    - State "REVIEWING"  from "TODO"       [2014-02-05 mié 15:23]
    :END:
** [3/7] Leo
*** [3/5] Video editor tests
**** DONE tests interfaz editor
**** DONE tests unitarios de modelo
**** DONE tests en travis (unitarios)
**** STARTED tests en travis (funcional)
problema con el driver de chrome
**** STARTED codigo en node y en el navegador
*** TODO migracion a menor precision en currentTime
*** TODO implementar diseño de mosto message en caspa
** [0/1] Mariana
*** [0/1] cerrar logo
**** STARTED Animar texto desde XML en AS2.0 y 3.0
* <2014-02-03 Mon> [1/5]
:LOGBOOK:
...
DEADLINE: <2014-02-03 Mon>
    ...
    :END:
*** [0/2] Extras, maybe
**** TODO GTK config editor for patero
DEADLINE: <2014-02-03 Mon>
**** STARTED DAL: redis/mongo mapper to Python objects
DEADLINE: <2014-02-03 Mon>
     :LOGBOOK:
