...
**** TODO Integración a caspa (ver con Josx)
** Adri
...
** josx
*** STARTED Tetra en UNQUI (asistir a Adri)
** adri
*** TODO Tetra en UNQUI (Fin de ajustes)
** mariana
...
**** STARTED Stand-alone version with Caspa flavor
     ...
     :END:
** pato
*** STARTED Ajustes visuales de Filmstrip en PlayoutView
*** STARTED + Algoritmo de generación de Frames
    :LOGBOOK:
    - State "STARTED"    from "TODO"       [2013-10-09 Wed 11:42]
    :END:
**** TODO Armar matriz para precalcular varias estrategias
** leo
*** STARTED Filmstrip new API Refactoring
** adri
...
**** TODO Ver que al desconectar se guarde bien el archivo de video
