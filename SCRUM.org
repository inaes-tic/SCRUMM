...
** tom
*** TODO Mosto explained
** adri
*** TODO (mlt) PosixSHM vs SHMSync (gstreamer)
** leo
*** TODO Filmstrip en POV
*** TODO FilmstripCapture en MediaView
** pato
*** TODO Mosto with Tom
** mariana
*** TODO Seguimiento Conadis
*** TODO Docs a contactos
*** TODO Camara de exportacion
** jmr
...
** jmr
*** STARTED Mosto stabilization and bugfixes
    :LOGBOOK:
