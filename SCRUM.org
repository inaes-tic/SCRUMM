...
**** TODO Merge
** [0/3] Josx
*** [0/3] MBC-Etiquette upgrades
**** STARTED Unify models (server and editor)
     :LOGBOOK:
     - State "STARTED"    from "TODO"       [2014-01-24 Fri 12:17]
     :END:
**** STARTED Serve filter from server as a view
     :LOGBOOK:
     - State "STARTED"    from "TODO"       [2014-01-24 Fri 12:17]
     :END:
**** TODO Move scheduling to the filter code
** [1/4] Leo
*** [1/4] Refactor video editor with backbone and knockout
...
**** TODO Create repository (inaes-tic)
** [0/1] Mariana
*** TODO Presupuesto MAM
** [0/1] Pato
*** TODO Refactoring D3Timeline
* <2014-01-20 Mon> [7/9]
** [3/4] Adri
*** [3/4] Generic Redis+Mongo transport layer
**** DONE Implement
     :LOGBOOK:
...
DEADLINE: <2013-12-09 Mon>
    ...
    :END:
** [0/1] Leo
*** STARTED Investigar Edicion In/Out (ver NovaCut)
DEADLINE: <2013-12-09 Mon>
:LOGBOOK:
...
DEADLINE: <2013-12-02 Mon>
     ...
     :END:
**** STARTED models jump to other collections
:LOGBOOK:
