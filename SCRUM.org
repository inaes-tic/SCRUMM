...
*** DONE Hablar con Ana Paula de Cooperar
    ...
    :END:
*** TODO Arreglar reunión con Conadis primera semana de enero
** pato
...
Se agregó un problema con los layers, a resolver con el z-index (DONE)
Subir zip con PNG's y generar el png con todos los frames
** tom
